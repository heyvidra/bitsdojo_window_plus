...
typedef Void TToggleFullScreenWindow(IntPtr window);
typedef DToggleFullScreenWindow = void Function(int window);
final DToggleFullScreenWindow toggleFullScreenWindow =
    _theAPI.ref.toggleFullScreenWindow.asFunction();
...
class BDWAPI extends Struct {
  ...
  external Pointer<NativeFunction<TToggleFullScreenWindow>>
      toggleFullScreenWindow;
