...
FLUTTER_PLUGIN_EXPORT FlBitsdojoWindowPlugin *
bitsdojo_window_plugin_new(FlPluginRegistrar *registrar);

FLUTTER_PLUGIN_EXPORT void
bitsdojo_window_plugin_register_with_registrar(FlPluginRegistrar *registrar);

class BitsdojoWindowGtk {
public:
  virtual void setCustomFrame(gboolean){};
  virtual void setAlwaysOnTop(gboolean){};
  virtual void setWindowTitleBarButtonVisibility(int button, gboolean visible) {
  };
  virtual void setBackgroundEffect(int effect) {};
};
...
FLUTTER_PLUGIN_EXPORT void
bitsdojo_window_set_dart_entrypoint_arguments(char **arguments);

FLUTTER_PLUGIN_EXPORT void
bitsdojo_window_configure_from_environment(GtkWindow *window);
